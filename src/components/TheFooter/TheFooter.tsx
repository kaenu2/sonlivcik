			...
			<Container maxWidth='xl'>
				<div className='footer__group'>
					<div className='footer__logo'>
						...
						<h2>
							Хочешь улучшить качество своего сна? Тогда тебе точно нужна помощь
							Сонливчика!
						</h2>
					</div>
					<div className='footer__info'>
						<div className='footer__contacts'>
							<h3>контакты</h3>
							<a href='tel:+79209195600'>тел: +7 920 919-56-00</a>
						</div>
						<div className='footer__addres addres-footer'>
							<h3>Мы в социальных сетях</h3>
							<div className='addres-footer__group'>
								<a href='mailto:sonlivcik@yandex.ru'>
									<MailIcon />
								</a>
								<a
